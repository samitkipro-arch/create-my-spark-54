  ...
  if (isMobile) {
    return (
      <Drawer open={open} onOpenChange={onOpenChange}>
        <DrawerContent className="mx-4 mb-4 h-[85vh] rounded-2xl bg-card/95 backdrop-blur-lg shadow-[0_10px_40px_rgba(0,0,0,0.4)] border border-border/50 overflow-hidden">
          {/* Bouton close (mobile) */}
          <button
            type="button"
            aria-label="Fermer"
            onClick={() => onOpenChange(false)}
            className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 bg-background/80 hover:bg-background/90"
          >
            <X className="h-4 w-4" />
          </button>

          {/* Conteneur scrollable limité */}
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <button
          ...
          aria-label="Fermer"
          onClick={() => onOpenChange(false)}
          className="absolute right-3 top-3 z-20 inline-flex h-9 w-9 items-center justify-center rounded-full border border-border/60 bg-background/80 hover:bg-background/90"
        >
          <X className="h-4 w-4" />
        </button>
