      ...
      <CardContent className="p-4 md:p-6">
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-2xl md:text-3xl font-bold text-[hsl(210,40%,98%)]">{value}</p>
          </div>
          <div className="p-2.5 md:p-3 bg-primary/10 rounded-lg self-start transition-all duration-200">
