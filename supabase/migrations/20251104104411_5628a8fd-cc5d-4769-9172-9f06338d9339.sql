-- Supprimer TOUTES les politiques existantes sur org_members
DROP POLICY IF EXISTS "org_members_insert_same_org" ON public.org_members;
...
DROP POLICY IF EXISTS "org_members_delete_same_org" ON public.org_members;
